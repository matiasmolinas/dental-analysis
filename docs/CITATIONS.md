...
|---|---|---|---|---|
| `delta_crp_anchor` | 0.5 mg/L | CRP reduction after periodontal therapy | Front Immunol 2025 dynamics (meta-analytic ΔhsCRP) | model-library.md |
| `delta_hba1c_anchor` | 0.35 pp | HbA1c reduction after periodontal therapy | Simpson/Cochrane 2022; Teshome 2017 | model-library.md |
| `crp_half_life` | 19.0 h | CRP plasma half-life | Pepys & Hirschfield 2003, J Clin Invest 111:1805 | model-library.md |
| `il6_half_life` | 2.0 h | IL-6 clearance half-life | human acute-phase IL-6 kinetics | model-library.md |
| `alpha_tau` | 0.019 1/yr | baseline tau growth rate (amyloid-positive) | Schäfer et al. 2021, Front Physiol 12:702975 | model-library.md |
...
[`BENCHMARK.md`](BENCHMARK.md) (protocol).
