"""Counterfactual-sensitivity test — tests REASONING, not vocabulary.
...
This is the fair way to ask whether an input reasons better (not just names more): a more
counterfactually-sensitive format is genuinely using its inputs.
